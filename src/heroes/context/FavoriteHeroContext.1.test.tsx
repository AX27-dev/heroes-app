...
describe('FavoriteHeroContext', () => {
  ...
  test('should add hero to favorites when toggleFavorite is called with a hero', () => {
    renderContextTest();
  ...
  test('should remove hero from favorites when toggleFavorite is called with a hero', () => {
