...
export const HeroPage = () => {
  ...
  const { data: heroData, isError } = useQuery({
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress value={heroData.strength * 10} className="h-2" />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress value={heroData.speed * 10} className="h-2" />
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <Progress value={heroData.durability * 10} className="h-2" />
                </CardContent>
              </Card>
            </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <Progress value={heroData.speed * 10} className="h-4" />
                    </div>
                    <div className="w-12 text-right font-bold">
                      {heroData.speed}/10
                    </div>
