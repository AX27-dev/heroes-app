    ...
    <>
      <div className="flex flex-col lg:flex-row gap-4 mb-8">
        ...
        <div className="flex gap-2">
          <Button
            variant={accordion === 'filters' ? 'default' : 'outline'}
            className="h-12"
            onClick={() => {
              if (accordion === 'filters') {
                // setQueryParams('accordion', ''); // fa el mateix ⬇️
                setSearchParams((prev) => {
                  prev.delete('accordion');
                  return prev;
                });
                return;
              }

              setQueryParams('accordion', 'filters');
            }}
          >
      ...
      {/* Advanced Filters */}
      <Accordion type="single" collapsible value={accordion}>
